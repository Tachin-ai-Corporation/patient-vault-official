...
export const ENDPOINTS: EndpointDef[] = [
  ...
  },
  {
    ...
    pathTemplate: '/patient/{id}/alias',
    needsPatient: true,
    description: 'Attach an alternate patient name. Type and at least one name field are required.',
    fields: [
      { name: 'type', label: 'Type', required: true, type: 'select', options: opt(['maiden', 'nickname', 'preferred', 'previous', 'legal_change', 'alias']), defaultValue: 'alias', in: 'body' },
      { name: 'alias', label: 'Alias or nickname', required: false, type: 'text', placeholder: 'Mari', example: 'Mari', in: 'body' },
      { name: 'firstName', label: 'First name', required: false, type: 'text', placeholder: 'Maria', example: 'Maria', in: 'body' },
      { name: 'lastName', label: 'Last name', required: false, type: 'text', placeholder: 'Gutierrez', example: 'Gutierrez', in: 'body' },
      { name: 'fullName', label: 'Full name', required: false, type: 'text', placeholder: 'Maria Gutierrez Santos', in: 'body' },
      { name: 'effectiveFrom', label: 'Effective from', required: false, type: 'text', placeholder: '2015-06-15', in: 'body' },
      { name: 'effectiveTo', label: 'Effective to', required: false, type: 'text', placeholder: '2020-06-15', in: 'body' },
    ],
  },
  {
    key: 'identifier-list',
