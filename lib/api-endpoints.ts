...
export const ENDPOINTS: EndpointDef[] = [
  ...
  },
  {
    ...
    needsPatient: true,
    description: 'Attach an external identifier (MRN, SSN, payer ID).',
    fields: [
      { name: 'system', label: 'System', required: true, type: 'text', placeholder: 'http://hl7.org/fhir/sid/us-mrn', example: 'http://hl7.org/fhir/sid/us-mrn', in: 'body' },
      { name: 'value', label: 'Value', required: true, type: 'text', placeholder: 'MRN-449120', example: 'MRN-449120', in: 'body' },
      { name: 'type', label: 'Type', required: false, type: 'text', placeholder: 'MR', example: 'MR', in: 'body' },
    ],
  },
  {
    key: 'contact',
  ...
  },
  {
    ...
    needsPatient: false,
    description: 'Match a patient by demographics. Returns scored candidates.',
    fields: [
      {
        name: 'purpose',
        label: 'Purpose',
        required: true,
        type: 'select',
        options: opt(['exact', 'candidates']),
        defaultValue: 'exact',
        helpText: 'exact returns only full matches; candidates returns probabilistic matches with scores.',
        in: 'query',
      },
      ...
      { name: 'sex_at_birth', label: 'Sex at birth', required: false, type: 'select', options: opt(['', 'female', 'male', 'other']), in: 'query' },
    ],
  },
  {
    key: 'attach',
